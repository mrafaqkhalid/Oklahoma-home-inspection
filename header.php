...
<body id="top" <?php body_class(); ?>>
  ...
  <div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'oklahoma home inspection & pest control'); ?></a>
    <header id="stickyHeader" class="container-fluid  bg-white stickyHeader">
      <!-- Top Navbar -->
      <nav class="d-none d-md-block p-2 border-bottom bg-white  px-lg-4 hide-below-992" style="font-size: 1.1rem; font-weight: 600;">
        <div class="custom-mx-responsive">
        <div class="container-fluid d-flex justify-content-between align-items-center" >
        <div class="contact-number d-flex flex-column flex-md-row align-items-md-center" > <!-- style="margin-left: 7rem;" -->
        ...
        <div class="social-link  d-flex" >  <!-- style="margin-right: 6rem;" -->
      ...
      <!-- Main Navbar -->
      <nav class="navbar navbar-expand-lg navbar-light  navbar.hidden  px-lg-4 custom-mx-responsive">
        <div class="container-fluid">
            ...
            <div class="d-lg-none d-flex align-items-center justify-content-between w-100  p-2">
              <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                <img class="" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.svg" alt="STL Home Inspection Logo" style="height: 60px;"> <!-- margin-left: 7rem; -->
              </a>
            ...
            <a class="navbar-brand d-none d-lg-block" href="<?php echo esc_url(home_url('/')); ?>">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.svg" alt="STL Home Inspection Logo" style="height:70px; "> <!-- margin-left: 7rem; -->
            </a>
          ...
          <!-- Navbar Button -->
<a href="<?php echo home_url(); ?>/#schedule-inspection" class="btn custom-btn-hover d-none d-lg-inline-block typography-heading " > <!-- style="margin-right: 6rem;" -->
  Schedule Inspection
</a>

      ...
      <div class="container">
        <div class="row g-4">
          ...
          <div class="col-12 col-md-6 col-lg-3 footer-column">
            <h5 class="text-uppercase fs-6 text-white mb-4 footer-title heading-footer">Contact Us</h5>
            <div class="footer-links">
              <a href="tel:314-805-2137" class="footer-contact-item">
          ...
          <!-- Address & Hours -->
          <div class="col-12 col-md-6 col-lg-3 footer-column">
            <h5 class="text-uppercase fs-6 text-white mb-4 footer-title heading-footer">Our Address</h5>
            <div class="footer-links">
              ...
              <div class="footer-contact-item">
                ...
                <div class="contact-info">
                  ...
                  <div class="value">Mon - Fri 8:00AM to 5PM</div>
                  <div class="value">Saturday 10AM to 2PM</div>
                  <div class="value">Sundays We Are Closed</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Associations -->
          <div class="col-12 col-md-6 col-lg-3 footer-column">
            <h5 class="text-uppercase fs-6 text-white mb-4 footer-title heading-footer">Associations</h5>
            <div class="footer-links associations-grid">
              <a href="https://www.nachi.org/certified-inspectors/billy-boerner-cmi-internachi-iac2-107501" class="association-link" target="_blank">
